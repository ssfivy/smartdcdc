/*! ------------------------------------------------------------------------- 
    \file scandal_config.h
        Scandal Configuration for Smart DCDC
...
#error "Device type multiply defined (redefined to smartdcdc)"
#endif
#define THIS_DEVICE_TYPE        SMARTDCDC

/* Number of channels */
#define NUM_IN_CHANNELS		SMARTDCDC_NUM_IN_CHANNELS
#define NUM_OUT_CHANNELS 	SMARTDCDC_NUM_OUT_CHANNELS
